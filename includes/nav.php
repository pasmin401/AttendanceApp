    ...
    <div class="topbar-right">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" id="user-dropdown">
          <a class="dropdown-item" href="<?= APP_URL ?>/profile.php">👤 My Profile</a>
          <?php if ($role === 'admin'): ?>
          <a class="dropdown-item" href="<?= APP_URL ?>/admin/index.php">⚙️ Admin Panel</a>
          <?php endif; ?>
          <a class="dropdown-item" href="<?= APP_URL ?>/dashboard.php">🏠 Dashboard</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item danger" href="<?= APP_URL ?>/logout.php">🚪 Log Out</a>
        </div>
      </div>
    </div>
  </header>
