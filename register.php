        ...
        try {
            ...
            if ($existingByUsername) {
                ...
                $error = 'This email is already registered.'
                       . ' <a href="index.php" style="font-weight:700;color:var(--primary)">Try logging in →</a>';
                ...
                if ($uid) {
                    ...
                    $error = 'Registration failed — the account could not be created. Please try again.';
                }
            }
            ...
            if ($e->getCode() == 23000) {
                ...
                $error = 'Username or email already exists.'
                       . ' <a href="index.php">Try logging in →</a>';
            } else {
