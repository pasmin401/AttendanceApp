    ...
    <div class="two-col" style="margin-bottom:20px">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="<?= APP_URL ?>/admin/reports.php" class="btn btn-outline btn-sm">Full Report</a>
        </div>
        <div class="card-body">
    ...
    <div class="card" style="margin-bottom:20px">
      <div class="card-header">
        ...
        <div style="display:flex;gap:8px">
          <a href="<?= APP_URL ?>/admin/reports.php?from=<?= $today ?>&to=<?= $today ?>" class="btn btn-outline btn-sm">View Details</a>
          <a href="<?= APP_URL ?>/admin/reports.php?export=1&from=<?= $today ?>&to=<?= $today ?>" class="btn btn-success btn-sm">⬇ Export CSV</a>
        </div>
      </div>
    ...
    <div class="two-col">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="<?= APP_URL ?>/admin/users.php" class="btn btn-outline btn-sm">Manage All</a>
        </div>
        <div class="card-body">
